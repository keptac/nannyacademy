    ...
    try {
      ...
      showDialog(
        ...
        builder: (ctx) => AlertDialog(
          title: Text('Success'),
          content: Text(
              'Job offer successfully submitted. You will receive an email shortly with your confirmation and invoice details.'),
          actions: [
            TextButton(
              onPressed: () {
                Navigator.of(ctx).pop();
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              serviceDisplay("Meeting Date",
                                  serviceRequest['meetingDate']),
                            ],
                          ),
                        ),
                        Divider(
