...
class Updatenannyacademy extends StatefulWidget {
  @override
  _UpdatenannyacademyState createState() => _UpdatenannyacademyState();
}

class _UpdatenannyacademyState extends State<Updatenannyacademy> {
  File idFile;
  File pofFile;
  var data;
  String _errorMsg = '';
